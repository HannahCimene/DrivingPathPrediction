...
def train_and_plot_losses(X_train, y_train, X_test, y_test, input_shape, epochs, batch_size, sequence_length):
    ...
    print(f"RNN Model stopped training after {len(rnn_history.history['loss'])} epochs.")
    ...
    print(f"LSTM Model stopped training after {len(lstm_history.history['loss'])} epochs.")
    ...
    print(f"LSTM with Attention Model stopped training after {len(lstm_attention_history.history['loss'])} epochs.")
