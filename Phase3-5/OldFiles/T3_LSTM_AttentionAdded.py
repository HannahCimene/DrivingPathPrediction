...
simple_rnn_model.fit(X_train, y_train, epochs=30, batch_size=32, verbose=1)
evaluate_model(simple_rnn_model, X_test, y_test, 'SimpleRNN')

# LSTM Model
print("\nLSTM Model:")
lstm_model = build_lstm_model(input_shape=(10, 2))
lstm_model.fit(X_train, y_train, epochs=30, batch_size=32, verbose=1)
evaluate_model(lstm_model, X_test, y_test, 'LSTM')

# LSTM Model with Attention
print("\nLSTM Model with Attention:")
lstm_attention_model = build_lstm_model_with_attention(input_shape=(10, 2))
lstm_attention_model.fit(X_train, y_train, epochs=30, batch_size=32, verbose=1)
evaluate_model(lstm_attention_model, X_test, y_test, 'LSTM with Attention')